...
// App get
// Aloitus
app.get('/', (req, res) => varasto.haeSatunnaiset()
    .then(tulostaulu => res.render('aloitus', {
        tulostaulu
    }))
    .catch(virhe => lahetaTilaviesti(res, virhe)));

// Kaikki
app.get('/kaikki', (req, res) => varasto.haeKaikki()
    .then(tulostaulu => res.render('kaikki', {
        tulostaulu
    }))
    .catch(virhe => lahetaTilaviesti(res, virhe)));

// Kategoriat
app.get('/kategoriat', (req, res) => res.render('kategoriat', {
}));
